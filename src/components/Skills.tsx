          ...
          <div className='flex flex-col max-w-md sm:flex-row'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-900'>
                Webtwo ipsum orkut reddit meebo skype vimeo jajah spock empressr zimbra, mobly
                napster.
              </p>
            </div>
          </div>
        ...
        <div className='space-y-6 sm:px-16'>
          <div className='flex flex-col max-w-md sm:flex-row'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-900'>
                Skate ipsum dolor sit amet, alley oop vert mute-air Colby Carter flail 180 berm over
                the sea.
              </p>
            </div>
          </div>
